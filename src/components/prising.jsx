...
const Pricing = () => {
  return (
    <div className=" pt-10w-full h-full">
      <div>
        <h2 className="text-3xl font-bold tracking text-center mt-12 sm:text-5xl ">
          Pricing
        </h2>
        <p className="max-w-3xl text-[#53d364] mx-auto mt-4 text-3xl font-bold text-center ">
      ...
      <div className=" flex item-center justify-center ">
        <div className="mt-24 container space-y-12 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8">
            ...
            <a
                className="bg-emerald-50 text-black hover:bg-emerald-100 mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium"
                href="#"
            >
                Signup for free
            </a>
            ...
            <div className="flex-1">
                ...
                <p className="absolute top-0 py-1.5 px-4 bg-[#53d364] text-black rounded-full text-l font-bold uppercase tracking-wide  transform -translate-y-1/2">
                Most popular
                </p>
                <p className="mt-4 flex items-baseline ">
